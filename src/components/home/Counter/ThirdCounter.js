...
class ThirdCounter extends Component {
  render() {
    return (
      <div className="third-div all-icons">
        {/******** Start Third div for Icons and paragraph ********/}
        <div className="third-counter icons ">
          {/*************** Start Third Icon ***************/}
